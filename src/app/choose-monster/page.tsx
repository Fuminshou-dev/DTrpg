...
export default function FightPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen items-center container mx-auto p-4 px-2 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 sm:gap-4 md:gap-6 lg:gap-8 w-full max-w-7xl">
          {allMonsters.map((monster) => (
            <div
              ...
              className={`flex flex-col items-center border shadow-inner shadow-rose-500 p-3 sm:p-4 md:p-6 gap-2 sm:gap-3 md:gap-4 rounded-lg w-3/4 mx-auto ${
                monster.monster_type === "Evil Deity"
                  ? "bg-gradient-to-r from-rose-700 to-black animate-boss border font-bold shadow-rose-700"
                  : "border"
              } shadow-inner shadow-rose-500 p-4 md:p-8 gap-4
               rounded-lg w-full lg:w-full mx-auto relative`}
            >
              <div
